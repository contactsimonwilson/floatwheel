 ...
 * * @return 0 read failed 1 read successfully
 * * @example uint8_t dataR; 
 * * ALR_ReadByte(2,&dataR); *   is to read the data from the address HK32F030M_EE_BEGIN+5, if the read is successful, return
