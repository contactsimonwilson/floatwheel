...
;  *		Header file for generic DVC1117 series.
...
typedef struct{  //本结构体中未做注释的成员为内部预留寄存器，随意写入可能会造成芯片工作异常！！
 union {struct{
  ...
  struct{
    u8 CM_H;    //REGMODE03/R106[7:0]/0xAA/第17~14节电池保护屏蔽控制位;0, 开启第n节电池保护;1, 关闭第n节电池保护, 同时默认关闭第n节电池电压测量
  }R106;
  struct{
    u8 CM_M;    //REGMODE03/R107[7:0]/0x55/第13~9节电池保护屏蔽控制位
  }R107;
  struct{
...
static const unsigned char DVC11XX_PresetConfigRegData_R81To121[]={
  0x00,0x9E,0x59,0xF9,0x2C,0xFF,0x28,0x05,0x40,       //R81-89
  0x40,0x18,0x18,0xB0,0x47,0xC7,0x18,0x18,0x50,0x10,  //R90-99
  0x88,0x00,0x00,0x00,0x00,0x00,0x55,0x54,0x00,0x68,  //R100-109
