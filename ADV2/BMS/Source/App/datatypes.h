...
typedef enum {
	...
	CAN_PACKET_BMS_V_TOT,				//¡Ì
	CAN_PACKET_BMS_I,					//¡Ì
	CAN_PACKET_BMS_AH_WH,				//¡Ì
	CAN_PACKET_BMS_V_CELL,				//¡Ì
	CAN_PACKET_BMS_BAL,					//¡Ì
	CAN_PACKET_BMS_TEMPS,				//¡Ì
	CAN_PACKET_BMS_HUM,					//¡Ì
	CAN_PACKET_BMS_SOC_SOH_TEMP_STAT,	//¡Ì
	CAN_PACKET_PSW_STAT,
	...
	CAN_PACKET_BMS_AH_WH_CHG_TOTAL,		//¡Ì
	CAN_PACKET_BMS_AH_WH_DIS_TOTAL,		//¡Ì
