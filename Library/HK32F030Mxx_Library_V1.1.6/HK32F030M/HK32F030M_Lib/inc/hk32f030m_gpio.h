...
/** @defgroup GPIO_IOMUX
  * @{
  */
#define IOMUX_PC3_TIM1CH3           0xFFFFFFFE           
#define IOMUX_PC3_TIM1CH1N          0x00000001
#define IOMUX_PC4_TIM1CH4           0xFFFFFFFD 
#define IOMUX_PC4_TIM1CH2N          0x00000002
#define IOMUX_PB5_SWCLK             0xFFFFFFFB 
#define IOMUX_PB5_I2C_SDA           0x00000004
...
#define IS_TIM2_SOURCE(TIM2_SOURCE)       (((TIM2_SOURCE) == TIM2_CN1_EXTERNAL) || ((TIM2_SOURCE) == TIM2_CN1_HSIDIV) || \
                                          ((TIM2_SOURCE) == TIM2_CN1_LSI_114) || ((TIM2_SOURCE) == TIM2_CN1_EXTERNAL_MAX))
