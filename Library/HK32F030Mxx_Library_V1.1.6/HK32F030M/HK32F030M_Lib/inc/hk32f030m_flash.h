...
#define OB_RDP_Level_0   ((uint8_t)0xAA55)
#define OB_RDP_Level_1   ((uint8_t)0xBB44)
/*#define OB_RDP_Level_2   ((uint8_t)0xCC33)*/ /* Warning: When enabling read protection level 2 
